...
def get_game_steps():
    ...
    steps = [
        ...
        ('Confirm Download', tap_macro, (860, 500), 40),       # Start
        ...
        ('Confirm Name', tap_macro, (648, 478), 6),
        ...
        ('Center Skill', swipe_macro, (640, 594, 923, 237, 1500), 10),
        ('Skip Turn', tap_macro, (1142, 623), 10),
        ...
        ('Check Blue', if_continue_blue, None, 2),
        ...
        ('Space', tap_macro, (1141, 663),15),
        ('Partner Checker', partner_logic, None, 120),
        ('Check Fight Ended', check_confirm, None, 3),
        ('Battle Continue', tap_macro, (1140, 667), 10),
        ...
        ('Global Mission', tap_macro, (605, 82), 2),
        ('Global Mission', tap_macro, (605, 82), 2),
        ('Global Mission', tap_macro, (605, 82), 2),
