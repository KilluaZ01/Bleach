...
def get_game_steps():
    ...
    steps = [
        ...
        ('Check Counter Text', check_counter_text, None, 1),
        ...
        ('Basic Attk', tap_macro, (1068, 538), 1),
        ('Basic Attk', tap_macro, (1068, 538), 1),
        ('Basic Attk', tap_macro, (1068, 538), 3),
        ('Basic Attk', tap_macro, (1068, 538), 3),
        ('Skip', tap_macro, (1180, 52), 3),
        ('Confirm', tap_macro, (870, 533), 17),
        ('Basic Attk', basic_attack_combo, None, 1),
        ...
        ('Basic Attk', basic_attack_combo, None, 1),
        ('Special Attk', tap_macro, (944, 493), 4),
        ('Basic Attk', basic_attack_combo, None, 55),
        ('Special Attk', tap_macro, (944, 493), 4),
        ('Basic Attk', basic_attack_combo, None, 55),
        ('Close in', tap_macro, (928, 684), 2),
        ('Close in', tap_macro, (928, 684), 22),
        ('Tap to Track', tap_macro, (120, 300), 9),
        ('Skip', tap_macro, (1180, 52), 3),
        ('Confirm', tap_macro, (870, 533), 6),
        ('Battle', tap_macro, (1205, 642), 6),
        ('Battle Mid', tap_macro, (660, 460), 4),
        ('Fight', tap_macro, (1052, 673), 6),
        ('Fight Start', tap_macro, (1130, 670), 28),
        ('Skip', tap_macro, (1180, 52), 3),
        ('Skip', tap_macro, (1180, 52), 3),
        ('Confirm', tap_macro, (870, 533), 14),
        ...
        ('Check Timer', check_timer, None, 12),
        ('Counter', tap_macro, (1177, 420), 3),
        ('Basic Attk', tap_macro, (1068, 538), 1),
        ('Basic Attk', tap_macro, (1068, 538), 1),
        ('Basic Attk', tap_macro, (1068, 538), 1),
        ...
        ('Ultimate', tap_macro, (1045, 406), 3),
        ('Dodge', tap_macro, (946, 632), 1),
        ('Ultimate', tap_macro, (1045, 406), 6),
        ('Special Attk', tap_macro, (944, 493), 3),
        ('Basic Combo', basic_attack_combo, None, 1),

        ('Fight Until Close', fight_until_close, None, 1),
        ('Close Tut', tap_macro, (1117, 182), 4),
        ('Special Attk', tap_macro, (944, 493), 3),
        ('Dodge', tap_macro, (946, 632), 1),
        ('Dodge', tap_macro, (946, 632), 1),
        ('Dodge', tap_macro, (946, 632), 6),
        ('Basic Attk', basic_attack_combo, None, 1),
        ('Basic Attk', basic_attack_combo, None, 1),
        ('Basic Attk', basic_attack_combo, None, 1),
        ('Basic Attk', basic_attack_combo, None, 1),
        ...
        ('Close In', tap_macro, (928, 684), 2),
        ('Close In', tap_macro, (928, 684), 10),
        ('Tap to Close', tap_macro, (640, 664), 8),
        ...
        ('Basic Combo Dodge', basic_attack_combo_dodge, None, 1),
        ('Basic Combo Dodge', basic_attack_combo_dodge, None, 1),
        ('Special Attk', tap_macro, (944, 493), 2),
        ('Basic Combo Dodge', basic_attack_combo_dodge, None, 1),
        ('Basic Combo Dodge', basic_attack_combo_dodge, None, 1),
        ('Special Attk', tap_macro, (944, 493), 2),
        ('Basic Combo Dodge', basic_attack_combo_dodge, None, 1),
        ...
        ('Third Sense', sense_three, None, 3),
        ('Skip', tap_macro, (1180, 52), 3),
        ('Confirm', tap_macro, (870, 533), 8),
        ...
        ('Tap to Close', tap_macro, (645, 541), 6),
        ...
        ('Gacha', tap_macro, (889, 651), 6),
        ('10x Gacha', tap_macro, (1146, 658), 4),
        ('Draw Till Next', draw_till_next, None, 1),
        ('Another Banner', tap_macro, (110, 293), 4),
